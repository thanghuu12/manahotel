                            ...
                            <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                                ...
                                <form action="<%=request.getContextPath()%>/customer/update-profile" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="phone" type="tel" class="form-control" id="phone" value="<%=customer.phone%>">
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form action="<%=request.getContextPath()%>/customer/change-password" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input required name="old_password" type="password" class="form-control" id="currentPassword">
                                        </div>
                                    </div>
