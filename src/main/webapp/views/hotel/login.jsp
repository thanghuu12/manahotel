                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    <h5 class="card-title text-center pb-0 fs-4">Đăng nhập khách sạn</h5>
                                </div>

                                <form class="row g-3 needs-validation" action="<%=request.getContextPath()%>/hotel/login" method="post" novalidate>
